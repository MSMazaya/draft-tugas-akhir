...
%Basic configuration
\title{\textit{Adaptive Control} dengan Model Prediktif berbasis \textit{Time Series} untuk Efisiensi Penggunaan Sumber Daya Kubernetes pada Pods Aplikasi \textit{Elastic Search}}
\date{}
\author{
